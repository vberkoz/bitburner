...
aws s3 cp app/robots.txt s3://$BUCKET_NAME/ --content-type "text/plain" --region $REGION --profile $PROFILE
aws s3 cp app/sitemap.xml s3://$BUCKET_NAME/ --content-type "application/xml" --region $REGION --profile $PROFILE
